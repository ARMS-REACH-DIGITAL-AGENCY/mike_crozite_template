...
- Do not place the destination URL, legal tracking parameters, or QR codes in
  the artwork.
- Do not submit animated files.
- Sponsor must own or have permission to use all submitted artwork and marks.
...
- Assigned school hub(s), or platform-wide designation
- Start and end dates
- Rotation weight, if sharing inventory with other campaigns

If only one creative is supplied, it may be rejected. Automatic cropping of a
single desktop file into the mobile slot is not guaranteed to preserve copy,
logos, faces, or CTA elements.
