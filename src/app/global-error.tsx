    ...
    <html lang="en">
      <head>
        ...
        <style>{`
          ...
          .code{font:700 72px "Bebas Neue",sans-serif;letter-spacing:.04em;color:#222;line-height:1}
          .msg{font:300 16px/1.6 Oswald,sans-serif;color:#888;margin:16px 0 32px}
          .btns{display:flex;gap:12px;justify-content:center}
          .btn{display:inline-block;font:700 13px Oswald,sans-serif;letter-spacing:.12em;text-transform:uppercase;padding:10px 28px;border:1px solid rgba(255,255,255,.2);color:#fff;text-decoration:none;cursor:pointer;background:none;transition:border-color .2s}
      ...
      <body>
        <div>
          ...
          <div className="code">Something broke</div>
          <div className="msg">We&apos;re working on it. Try refreshing or go back to the main site.</div>
          <div className="btns">
