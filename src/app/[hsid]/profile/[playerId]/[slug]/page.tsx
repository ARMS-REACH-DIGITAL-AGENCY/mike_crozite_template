// src/app/[hsid]/profile/[playerId]/[slug]/page.tsx
// NEW CLEAN PLAYER PROFILE PAGE — preview route (Phase 2)
...
export async function generateMetadata({
  ...
  try {
    ...
    // Canonical still points to /player/ (the production route)
...
export default async function NewPlayerProfilePage({
  ...
  // Redirect to canonical slug within the /profile/ preview route
  if (slug !== canonicalSlug) permanentRedirect(`/${hsid}/profile/${safePlayerId}/${canonicalSlug}`);
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // RENDER — Row 5 content only. Shell is provided by [hsid]/layout.tsx.
  // ═══════════════════════════════════════════════════════════════════════════
  return (
    <>
