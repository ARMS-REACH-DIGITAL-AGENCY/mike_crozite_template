    ...
    <>
      <style>{`
        ...
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .pab{position:sticky;top:calc(var(--stickyHeaderH,120px) + var(--metaBandH,60px));z-index:40;padding:0 0;margin:0}
        /* STATS */
      ...
      {/* PLAYER ACTION BAR (tabs) */}
      <PlayerActionBar activeTab="overview" />
...
(function(){
  ...
  (function setLayoutVars(){
    ...
    var tabBar=document.querySelector('.pab');
  ...
  function activateTab(name){
    ...
    document.querySelectorAll('.pab-btn').forEach(function(t){t.classList.remove('active');t.setAttribute('aria-selected','false');t.setAttribute('tabindex','-1');});
    document.querySelectorAll('.tab-content').forEach(function(c){c.classList.remove('active');});
    var tab=document.querySelector('.pab-btn[data-profile-tab="'+name+'"]');
  ...
  document.querySelectorAll('.pab-btn').forEach(function(tab){
