  ...
  return (
    <>
      <style>{`
        ...
        /* PROFILE TABS — sticky under header */
        ...
        /* DRAWER LIVE RESULTS — injected by player-search JS into #liveResults */
        ...
        @media(max-width:640px){
          /* Restore shared crestH to standard mobile size (overrides the 60px set above) */
          :root{--crestH:44px}
