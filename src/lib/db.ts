...
// tbc_batting_raw.teamid is an integer column.  The teamid is surfaced as
// team_name so callers always get a value without requiring a teams table.
// ---------------------------------------------------------------------------
...
//
// Does not join the teams table to avoid integer/text type mismatches when
// tbc_pitching_raw.teamid is an integer column.  The teamid is surfaced as
// team_name so callers always get a value without requiring a teams table.
// ---------------------------------------------------------------------------
