  ...
  return (
    <style>{`
      ...
      *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
      ...
      .yat-school-stripe{height:1px;background:var(--school-color1,rgba(255,255,255,0.2));flex-shrink:0}
      ...
      .career-strip{background:linear-gradient(160deg,#07071a 0%,#0d0d1f 50%,#07071a 100%);border-bottom:1px solid var(--school-color1,rgba(255,255,255,0.2))}
      ...
      .gallery-strip{background:var(--card-bg);border-bottom:1px solid var(--school-color1,rgba(255,255,255,0.2))}
      /* funnel-strip visual theme — card bg + school-color border (CTA pages) */
      .funnel-strip{background:var(--card-bg);border-bottom:1px solid var(--school-color1,rgba(255,255,255,0.2))}
