...
body.light-theme{
  ...
  font:700 18px/0.95 "Bebas Neue",sans-serif;
  letter-spacing:.03em;
  text-transform:uppercase;
  color:var(--back-fg);
  margin-bottom:4px;
  ...
  background:#111;
     ...
     .yat-back-bio-line{
  font:300 8px/1.15 Oswald,sans-serif;
...
.yat-back-cta{
  ...
  background:var(--back-cta-bg);
  color:var(--back-cta-fg);
  border-radius:12px;
  text-align:center;
  ...
  clip-path:polygon(0 0,100% 0,50% 100%);
     ...
     .yat-back-cta span{
  font:700 8px/1.08 Oswald,sans-serif;
  text-transform:uppercase;
...
.yat-back-iconnav{
  ...
  background:var(--back-tab-bg);
  color:var(--back-tab-fg);
  border-top:1px solid var(--back-line);
  border-bottom:1px solid var(--back-line);
  margin-top:0;
  flex-shrink:0;
}
  ...
  min-height:38px;
  padding:5px 2px 6px;
  border-right:1px solid var(--back-line);
  background:transparent;
  color:inherit;
}

      .yat-back-iconnav-item:last-child{
        border-right:none;
      }

      .yat-back-iconnav-item i{
        font-size:13px;
        line-height:1;
      }

      .yat-back-iconnav-item span{
        font:500 6px/1 Oswald,sans-serif;
        letter-spacing:.01em;
      }

      .yat-back-iconnav-item.is-active::after{
        content:"";
        position:absolute;
        left:18%;
        right:18%;
  ...
  text-align:center;
  padding:4px 6px;
  font:700 10px/1 "Bebas Neue",sans-serif;
  margin:0 0 6px;
  border-radius:8px;
  flex-shrink:0;
}

      .yat-stats-bar-target{
        font-size:11px;
        letter-spacing:.05em;
      }
  ...
  color:var(--back-muted);
      ...
      .yat-stat-label-target{
        font:300 7px/1 Oswald,sans-serif;
        letter-spacing:.04em;
      }
