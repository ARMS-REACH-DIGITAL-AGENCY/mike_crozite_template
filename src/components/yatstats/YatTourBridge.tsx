...
export default function YatTourBridge() {
  useEffect(() => {
    ...
    /*
      Embedded tour gesture contract:
      - one-finger scrolling/tapping remains native at 1x;
      - a two-finger pinch is prevented from reaching the top-level browser zoom;
      - the pinch is reported to the parent device viewport, which magnifies only
        the framed microsite;
      - while magnified, one-finger dragging pans that framed view;
      - double-tap while magnified resets the framed view to fit.
    */
