  ...
  return (
    <div className="yat-snap" aria-label="7-Day Snapshot - schedule and game log">
      ...
      <style>{`
        ...
        .yat-snap-date-day{
          font:700 clamp(9.5px,3.6cqi,17px)/1.05 "Bebas Neue",sans-serif;
          color:#17120c;
        }
        .yat-snap-logo{
        ...
        .yat-snap-matchup{
          font:700 clamp(7px,2.4cqi,11px)/1.1 Oswald,sans-serif;
          letter-spacing:.02em;
          text-transform:uppercase;
          color:#221a12;
          white-space:nowrap;
        ...
        .yat-snap-venue{
          font:400 clamp(6px,1.8cqi,8.5px)/1.1 Oswald,sans-serif;
          color:#8a7c68;
          white-space:nowrap;
          overflow:hidden;
          text-overflow:ellipsis;
        ...
        .yat-snap-score{
          font:700 clamp(7.5px,2.6cqi,11.5px)/1.1 "Bebas Neue",Oswald,sans-serif;
          letter-spacing:.02em;
          white-space:nowrap;
        }
        ...
        .yat-snap-homeaway{
          ...
          align-items:center;
          justify-content:center;
          width:clamp(10px,3.4cqi,15px);
          flex:0 0 auto;
          color:#8a7c68;
          font-size:clamp(9.5px,3cqi,13px);
        }
        .yat-snap-offday{
          grid-column:2 / -1;
          text-align:center;
          font:700 clamp(7px,2.4cqi,10.5px)/1 Oswald,sans-serif;
          letter-spacing:.08em;
          text-transform:uppercase;
          color:#a89a86;
        }
