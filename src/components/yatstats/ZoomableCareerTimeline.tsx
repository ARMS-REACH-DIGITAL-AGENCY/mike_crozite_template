  ...
  return (
    <section className="zt-shell-images" id="playerCareerImages">
      ...
      <style jsx>{`
        ...
        .zt-img-card { position:relative; display:block; height:100%; overflow:hidden; background:transparent; border:0 !important; box-shadow:none; transition:none; }
        ...
        .zt-img-card :global(.zt-anchor-bg) { position:absolute; inset:0; z-index:1; display:block; width:100%; height:100%; object-fit:cover; object-position:58% center; transform:scale(1.08); transform-origin:center center; }
