    ...
    return (
      <section className="zt-shell zt-shell-images" id="playerCareerImages">
        ...
        <style jsx>{`
          ...
          .zt-img-moment { position: absolute; top: 5px; width: 52px; height: 76px; transform: translateX(-50%); border: 0; padding: 0; background: transparent; cursor: pointer; }
          ...
          .zt-img-connector { position: absolute; z-index: 1; left: 50%; top: 76px; width: 1px; height: calc(var(--row4-h, 48px) + 18px); transform: translateX(-50%); background: linear-gradient(180deg, rgba(245,200,90,.18), rgba(245,200,90,.95)); box-shadow: 0 0 12px rgba(245,200,90,.34); pointer-events: none; }
          ...
          @media (max-width: 760px) { .zt-img-moment { width: 46px; height: 68px; } .zt-img-card { width: 46px; height: 68px; } .zt-img-connector { top: 68px; } }
        `}</style>
      </section>
    );
  }
  ...
  return (
    <section className={`zt-shell ${variant === 'line' ? 'zt-shell-line' : ''}`} id="playerCareerStrip">
      ...
      <style jsx>{`
        ...
        @media (max-width: 760px) { .zt-meta { width:122px; } .zt-controls { right:8px; } .zt-controls input { width:78px; } }
      `}</style>
    </section>
  );
}
