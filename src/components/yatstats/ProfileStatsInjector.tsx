...
function css() {
  return `<style id="profile-stats-injector-css">
    ...
    #ppTab-stats .psi-table { min-width:0; width:max-content; border-collapse:separate; border-spacing:0; font:500 9.5px/1.05 Oswald, Arial, sans-serif; color:var(--psi-text); table-layout:fixed; }
